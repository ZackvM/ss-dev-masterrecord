...
class pagebuilder { 
  ...
  private $registeredPages = array('login','root','datacoordinator','documentlibrary','hprreview','scienceserverhelp','reports','procurebiosample','collectiongrid','paymenttracker','systemreports','biogroupdefinition');  
